<template>
    <div id="setup" :class="{ 'fix': fix }" v-italic>
        ...
        <div id="left-settings" class="settings">
            ...
            <div class="checkbox-line"><router-link to="/lang" class="lang-settings">{{ texts.selectLanguage }}</router-link></div>
        </div>
        ...
        data() {
            return {
                ...
                texts: {
                    ...
                    selectLanguage: trans('selectLanguage'),
                }
            }
        },
        methods: {
